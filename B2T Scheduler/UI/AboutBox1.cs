...
namespace B2T_Scheduler
{
    partial class AboutBox1 : Form
    {
        public AboutBox1()
        {
            ...
            {
                this.labelVersion.Text = "Version: [NOT DEPLOYED]";
            }
            ...
            try
            {
                rtb_ReleaseNotes.LoadFile(Application.StartupPath + "\\Documents\\ReleaseNotes.rtf");
            }
            catch
            {
                rtb_ReleaseNotes.Text = "Error loading file: " + Application.StartupPath + "\\Documents\\ReleaseNotes.rtf";
            }
        }
