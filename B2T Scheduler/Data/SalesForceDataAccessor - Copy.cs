...
namespace B2T_Scheduler
{
    public class SalesForceDataAccessor
    {
        ...
        async Task<int> GetFormatCategoriesAsync() //OK
        {
        ...
        async Task<int> GetAppointmentCategoriesAsync() //OK
        {
        ...
        async Task<int> GetFormatsAsync()//OK
        {
        ...
        async Task<int> GetEventsAsync(DateTime? startDate = null, DateTime? endDate = null, DateTime? modifiedSince = null)
        {
            ...
            //q.QueryComplete(table.TableName + "(Events)", response.Records.Count);
